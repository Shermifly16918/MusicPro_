        ...
        <div class="row justify-content-center">
            ...
            <div class="lg:flex lg:-mx-2">
                <div class="space-y-3 lg:w-1/5 lg:px-2 lg:space-y-4">
                    <a href="#" class="block font-medium text-black dark:text-gray-300 hover:bg-purple-300">Guitarras</a>
                    <a href="#" class="block font-medium text-black dark:text-gray-300 hover:bg-purple-300">Bajos</a>
                    <a href="#" class="block font-medium text-black dark:text-gray-300 hover:bg-purple-300">Percusión</a>
                    <a href="#" class="block font-medium text-black dark:text-gray-300 hover:bg-purple-300">Amplificadores</a>
                    <a href="#" class="block font-medium text-black dark:text-gray-300 hover:bg-purple-300">Accesosrios Varios</a>
                </div>
                ...
                <div class="row">
                    @foreach ($categories as $category)
                        <h2 class="mt-2 text-lg font-medium text-gray-700 dark:text-gray-200">{{ $category->nombre_categoria}}</h2>
                        <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                            @foreach ($productsByCategory[$category->id] as $product)
                                <div class="flex flex-col items-center justify-center w-full max-w-lg mx-auto">
                                    ...
                                    <form action="{{ route('cart.store_') }}" method="POST">
                                        {{ csrf_field() }}
