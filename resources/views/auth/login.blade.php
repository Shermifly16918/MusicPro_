...
<body>
        ...
        <div class="h-screen md:flex">
            ...
            <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
                <form class="bg-white" action="{{route('login-user')}}" method="post" >
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <input class="pl-2 outline-none border-none bg-white" type="text" name="email" id="" value="{{old('email')}}" placeholder="Email" />
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                        ...
                        <input class="pl-2 outline-none border-none bg-white" type="password" name="contrasena" id=""  placeholder="Contraseña" />
                        <span class="text-sm ml-2">@error('password') {{$message}} @enderror</span>
                    </div>
